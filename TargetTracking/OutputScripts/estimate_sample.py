...
inputfilename = "D:/results/cont/TargetTracking_sample_2.txt"

t, x, err_1, err_2, err_3 = np.loadtxt(inputfilename, delimiter = ' ', usecols=(0,1,2,3,3), unpack=True, dtype=float)
from pylab import *
