...
namespace UKF
{
    public class UKFTest
    {
        ...
        /// Means weights
        /// </summary>
        public Matrix<double> Wm;

        /// <summary>
        /// Covariance weights
        /// </summary>
        public Matrix<double> Wc;
        ...
        /// <returns></returns>
        public Matrix<double>[] Update(Func<Matrix<double>,Matrix<double>> f, Matrix<double> x, Matrix<double> P, Func<Matrix<double>,Matrix<double>> h, Matrix<double> z, Matrix<double> Q, Matrix<double> R)
        {
        ...
        public Matrix<double>[] UnscentedTransform(Func<Matrix<double>,Matrix<double>> f, Matrix<double> X, Matrix<double> Wm, Matrix<double> Wc, int n, Matrix<double> R)
        {
            int L = X.ColumnCount;
            ...
            for (int k = 0; k < L; k++)
            {
                ...
                Y.SetSubMatrix(0, Y.RowCount, k, 1, f(row_in_X));
        ...
        public Matrix<double> GetSigmaPoints(Matrix<double> x, Matrix<double> P, double c)
        {
