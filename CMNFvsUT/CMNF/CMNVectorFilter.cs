...
{
    /// <summary>
    /// <para>Original Conditionnaly Minimax Nonlinear filter for a model x_{t+1} = Phi_1(x_t) + Phi_2(x_t) W_t, y_t = Psi_1(x_t) + Psi_2(x_t) Nu_t, W_t ~ (M_w, R_w), Nu_t ~ (M_nu, R_nu)</para>
    /// <para>Usage:</para>
