...
{
    public class TestLogisticModelScalar : TestEnvironmentVector
    {
    ...
    public class TestLogisticModelZeroScalar : TestEnvironmentVector
    {
    ...
    public class TestLogisticModelUniformNoiseScalar : TestEnvironmentVector
    {
