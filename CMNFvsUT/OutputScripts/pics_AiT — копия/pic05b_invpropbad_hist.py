...
filename = u'D:/results/invprop_bad_mcmnf_revised/InverseProportionBad_bulk_0.txt'
data = pd.read_csv(filename, delimiter = " ", header=0, dtype=float, engine='python')
n, bins, patches = plt.hist(data['49'].values[:], 40, range=(-500,2000), density=1, facecolor='black', alpha=0.5)
